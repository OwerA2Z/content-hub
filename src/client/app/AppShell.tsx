...
export function AppShell({ onLogout }: { onLogout: () => void }) {
  ...
  return <Layout>
    <Layout.Sider width={240} breakpoint="md" collapsedWidth={0} trigger={null} collapsible collapsed={sidebarCollapsed} onCollapse={setSidebarCollapsed}>
      <Flex vertical>
        <Space align="center" size={12}><Typography.Text strong>文</Typography.Text>{!sidebarCollapsed && <Typography.Text strong>内容中台</Typography.Text>}</Space>
        {menu}
