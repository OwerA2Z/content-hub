...
export function Stat({ label, value, hint }: { label: string; value: string | number; hint: string }) {
  return <Card className="app-stat-card"><CardContent><Statistic title={label} value={value} /><small className="mt-2 block text-xs text-muted-foreground">{hint}</small></CardContent></Card>;
}
