...
import { articleMediaSchema, articleStatusSchema } from "../../shared/contracts";
...
export function createArticlesRouter() {
  ...
  router.get("/articles", requireAdminOrScopes(["articles:read"]), async (req, res, next) => {
  ...
  router.get("/articles/:id", requireAdminOrScopes(["articles:read"]), async (req, res, next) => {
  ...
  router.get("/articles/:id/similar", requireAdminOrScopes(["articles:read", "dedup:check"]), async (req, res, next) => {
