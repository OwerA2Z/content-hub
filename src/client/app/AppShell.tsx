...
import { FileText, LayoutDashboard, ListTodo, LogOut, Radio, Sparkles, TerminalSquare } from "lucide-react";
...
type PageId = "dashboard" | "articles" | "planning" | "candidates" | "api" | "channels";
const navItems = [{ id: "dashboard", label: "工作台", icon: LayoutDashboard }, { id: "articles", label: "文章管理", icon: FileText }, { id: "planning", label: "内容规划", icon: ListTodo }, { id: "candidates", label: "AI 推荐", icon: Sparkles }, { id: "api", label: "API 中心", icon: TerminalSquare }, { id: "channels", label: "微信公众号", icon: Radio }] as const;
